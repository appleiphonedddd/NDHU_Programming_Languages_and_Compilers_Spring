...
static const yytype_int16 yyrline[] =
{
     ...
     149,   151,   153,   155,   157,   161,   170,   176,   185,   191,
     194,   202,   207,   212,   219,   224,   230,   233,   238,   241,
     245,   248,   252,   256,   260,   263,   268,   271,   274,   277,
     280,   283,   288,   292,   296,   300
};
#endif
...
#line 162 "t_parse.y"
                { (yyval.sm) = create_stm();
		  (yyval.sm)->stm_id = sVARDCL;
		  (yyval.sm)->exp1 = (yyvsp[-2].ex);
		  (yyval.sm)->exp2 = create_exp();
		  (yyval.sm)->exp2->exp_id = eID;
		  strcpy((yyval.sm)->exp2->name, (yyvsp[-1].sr));
		  // Insert variable declaration into symbol table
		  symtab = create_symnode((yyvsp[-1].sr), (yyvsp[-2].ex)->ival); }
#line 1368 "t_parse.c"
    break;
...
#line 171 "t_parse.y"
                { (yyval.sm) = (yyvsp[0].sm);
		  // Insert variable assignment into symbol table if necessary
		  symtab = create_symnode((yyvsp[0].sm)->exp1->name, (yyvsp[-1].ex)->ival); }
#line 1376 "t_parse.c"
    break;
